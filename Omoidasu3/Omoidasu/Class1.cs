...
// i replaced T with Card because it fixes debugging, using T ruins debugging completely
...
namespace KaimiraGames
{
    ...
    /// </summary>
    public class WeightedList<Card> : IEnumerable<Card>
    {
        /// <summary>
        ...
        /// </summary>
        public WeightedList(ICollection<WeightedListItem<Card>> listItems, Random rand = null)
        {
            _rand = rand ?? new Random();
            foreach (WeightedListItem<Card> item in listItems)
            {
        ...
        public IReadOnlyList<Card> Items => _list.AsReadOnly();

        public IEnumerator<Card> GetEnumerator() => _list.GetEnumerator();

        IEnumerator IEnumerable.GetEnumerator() => _list.GetEnumerator();

        public void Add(Card item, int weight)
        {
            _list.Add(item);
        ...
        public void Add(ICollection<WeightedListItem<Card>> listItems)
        {
            foreach (WeightedListItem<Card> listItem in listItems)
            {
        ...
        public void Contains(Card item) => _list.Contains(item);

        public int IndexOf(Card item) => _list.IndexOf(item);

        public void Insert(int index, Card item, int weight)
        {
        ...
        public Card this[int index] => _list[index];

        public int Count => _list.Count;

        public void SetWeight(Card item, int newWeight) => SetWeightAtIndex(IndexOf(item), FixWeight(newWeight));

        public int GetWeightOf(Card item) => GetWeightAtIndex(IndexOf(item));
